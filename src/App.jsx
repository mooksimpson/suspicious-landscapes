...
const EXAMPLES = [
  ...
  { title: "Golden Summer, Eaglemont (1889) by Arthur Streeton", file: "Arthur Streeton - Golden summer, Eaglemont - Google Art Project.jpg" },
  { title: "A Bush Idyll (1896) by Frederick McCubbin", file: "Frederick McCubbin - A bush idyll - Google Art Project.jpg" },
  { title: "Shearing the Rams (1890) by Tom Roberts", file: "Tom Roberts - Shearing the rams - Google Art Project.jpg" },
  { title: "The Purple Noon's Transparent Might (1896) by Arthur Streeton", file: "Arthur Streeton - 'The purple noon's transparent might' - Google Art Project.jpg" },
  { title: "Down on His Luck (1889) by Frederick McCubbin", file: "Frederick McCubbin - Down on His Luck - Google Art Project.jpg" },
  { title: "The Selector's Hut (1890) by Arthur Streeton", file: "Arthur Streeton - The selector's hut (Whelan on the log) - Google Art Project.jpg" },
  { title: "Bailed Up (1895) by Tom Roberts", file: "Tom Roberts - Bailed Up, 1895.jpg" },
  { title: "The Pioneer (1904) by Frederick McCubbin", file: "Frederick McCubbin - The pioneer - Google Art Project.jpg" },
  { title: "A Break Away! (1891) by Tom Roberts", file: "Tom Roberts - A break away! - Google Art Project.jpg" },
  { title: "The Spirit of the Drought (1896) by Arthur Streeton", file: "Arthur Streeton - The spirit of the drought - Google Art Project.jpg" },
  // American - Manifest Destiny / Hudson River / Western
  { title: "American Progress (1872) by John Gast", file: "American Progress (John Gast painting).jpg" },
  { title: "Washington Crossing the Delaware (1851) by Emanuel Leutze", file: "Washington Crossing the Delaware by Emanuel Leutze, MMA-NYC, 1851.jpg" },
  { title: "Among the Sierra Nevada (1868) by Albert Bierstadt", file: "Albert Bierstadt - Among the Sierra Nevada, California - Google Art Project.jpg" },
  { title: "The Rocky Mountains, Lander's Peak (1863) by Albert Bierstadt", file: "Albert Bierstadt - The Rocky Mountains, Lander's Peak.jpg" },
  { title: "Emigrants Crossing the Plains (1869) by Albert Bierstadt", file: "Albert Bierstadt - Emigrants Crossing the Plains - Google Art Project.jpg" },
  { title: "The Oxbow (1836) by Thomas Cole", file: "Cole Thomas The Oxbow (The Connecticut River near Northampton 1836).jpg" },
  { title: "Westward the Course of Empire (1861) by Emanuel Leutze", file: "Leutze, Emanuel — Westward the Course of Empire Takes Its Way — 1861.jpg" },
  { title: "The Last of the Mohicans (1827) by Thomas Cole", file: 'Thomas Cole - Scene from "The Last of the Mohicans", Cora Kneeling at the Feet of Tamenund - Google Art Project.jpg' },
  { title: "Fur Traders Descending the Missouri (1845) by George Caleb Bingham", file: "George Caleb Bingham - Fur Traders Descending the Missouri - WGA2205.jpg" },
  { title: "Daniel Boone Escorting Settlers (1851) by George Caleb Bingham", file: "George Caleb Bingham - Daniel Boone Escorting Settlers through the Cumberland Gap.jpg" },
];

const RAIN_EMOJIS = ["😬","😨","☠️","👀","🐙","🧌","👾","👺","👹"];

const MOOK_PAINTINGS = [
  { title: "The Visitors", year: 2025, caption: '20"x16". Oil on canvas. Painted on a reproduction of "Fur Traders Descending the Missouri" by George Caleb Bingham, 1843.', img: "/paintings/TheVisitors_480.jpg" },
  { title: "Faithful Steed", year: 2025, caption: '16"x20". Oil on canvas. Painted on a reproduction of "Portrait of George Washington Taking the Salute at Trenton" by John Faed, 1856.', img: "/paintings/FaithfulSteed_480.jpg" },
  { title: "The Show, Now Streaming", year: 2025, caption: '20"x16". Oil on canvas. Painted on a reproduction of "The Oregon Trail" by Albert Bierstadt, 1869.', img: "/paintings/NowStreaming_480.jpg" },
  { title: "Going Through The Loot", year: 2025, caption: '101x115cm. Oil on canvas. Painted on a reproduction of "Bailed Up" 1895 by Tom Roberts. Winner People\'s Choice Waverly Art Prize, 2025.', img: "/paintings/GoingThroughTheLoot1_480.jpg" },
  { title: "Photobomb on the Missouri", year: 2025, caption: '18"x20". Oil on canvas. Painted on a reproduction of "Boatmen on the Missouri" 1846 by George Caleb Bingham.', img: "/paintings/PhotoBombOnTheMissouri-Mook-Simpson-2025_480.jpg" },
  { title: "Surprised, Niagara", year: 2025, caption: '24"x20". Oil on canvas. Painted on a reproduction of "Niagara" 1857 by Frederic Edwin Church.', img: "/paintings/SurprisedNiagra_480.jpg" },
  { title: "Whasssaaaaa", year: 2025, caption: '22"x20". Oil on canvas. Painted on a reproduction of "American Progress" 1872 by John Gast.', img: "/paintings/Whassssaaaaaa_480.jpg" },
  { title: "Caressing The Delaware", year: 2025, caption: '20"x20". Oil on canvas. Painted on a replica of "Washington Crossing The Delaware" by Emanuel Leutze, 1776.', img: "/paintings/CaressingTheMissouri-Mook-Simpson-2025_480.jpg" },
  { title: "Air Dancer, Western", year: 2025, caption: '21"x20". Oil on canvas. Painted on a replica of "In Safe Hands" by Charles Schreyvogel, 1909.', img: "/paintings/Air-Dancer-Western-Mook-Simpson-2025-1_480.jpg" },
  { title: "The Bastard", year: 2024, caption: '71cm x 102cm. Oil on canvas. Painted on a reproduction of "The Pioneer" by Frederick McCubbin, 1904.', img: "/paintings/thebastard_480.jpg" },
  { title: "The North Wind", year: 2024, caption: '61cm x 71cm. Oil on canvas. Painted on a reproduction of "The North Wind" by Frederick McCubbin, 1888.', img: "/paintings/240516_Mook-0413-2_480.jpg" },
  { title: "Transparent Nightmare", year: 2024, caption: '56cm x 56cm. Oil on canvas. Painted on a reproduction of "The Purple Noon\'s Transparent Might" by Arthur Streeton, 1896.', img: "/paintings/TransparentNightmare_480.jpg" },
];
...
function App() {
  ...
  const [aboutPainting] = useState(() => MOOK_PAINTINGS[Math.floor(Math.random() * MOOK_PAINTINGS.length)]);
  ...
  const loadExample = async () => {
    ...
    try {
      const res = await fetch("/api/fetch-example", {
        ...
        body: JSON.stringify({ filename: example.file }),
      });
      ...
      {showAbout && (
        <div style={S.aboutOverlay}>
          <div style={S.aboutContent}>
            <button onClick={() => setShowAbout(false)} style={S.aboutClose}>✕</button>
            <h2 style={S.aboutTitle}>ABOUT THIS TOOL</h2>
            <div style={S.aboutDivider}/>
            <div style={S.aboutImgFrame}>
              <img src={aboutPainting.img} alt={aboutPainting.title} style={S.aboutImg}/>
            </div>
            <p style={S.aboutPaintingTitle}>"{aboutPainting.title}"</p>
            <p style={S.aboutPaintingArtist}>Mook Simpson, {aboutPainting.year}</p>
            <p style={S.aboutPaintingCaption}>{aboutPainting.caption}</p>
            <div style={S.aboutDivider2}/>
            <p style={S.aboutText}>This tool lets you interrogate any image using the same critical framework that artist Mook Simpson applies when selecting the historical landscapes he paints his monsters into.</p>
            <p style={S.aboutText}>It examines what's unseen, what's ignored, and what's been carefully smoothed over: the mythologies, the cultural anxieties, the symbolic machinery operating beneath the surface of beloved paintings, and in fact any image at all.</p>
            <p style={S.aboutPunch}>A surefire way to ruin any image you previously quite liked.</p>
            <p style={S.aboutText}>In Mook's case, this is all done with great playful joy and a sense of humour, which you can experience by checking out his work at <a href="http://mooksimpson.com" target="_blank" rel="noopener noreferrer" style={S.aboutLink}>mooksimpson.com</a>.</p>
            <button onClick={() => setShowAbout(false)} style={S.aboutBackBtn}>← Back to tool</button>
          </div>
        </div>
      )}

      <footer style={S.footer}>
        <a href="http://mooksimpson.com" target="_blank" rel="noopener noreferrer" style={S.footerName}>MOOK SIMPSON</a>
        <button onClick={() => setShowAbout(true)} style={S.footerAbout}>ABOUT THIS TOOL</button>
      </footer>
    </div>
  );
}
...
const S = {
  ...
  footer: { textAlign: "center", padding: "32px 0 48px", borderTop: `1px solid ${C.border}`, marginTop: 20, display: "flex", flexDirection: "column", alignItems: "center", gap: 8 },
  footerName: { fontSize: 13, letterSpacing: "0.15em", fontWeight: 700, color: C.text, textDecoration: "none", fontFamily: "'Inter',sans-serif" },
  footerAbout: { fontSize: 11, letterSpacing: "0.1em", color: C.muted, background: "none", border: "none", cursor: "pointer", fontFamily: "'Inter',sans-serif", textDecoration: "underline", textUnderlineOffset: 3 },

  // About page
  aboutOverlay: { position: "fixed", inset: 0, zIndex: 200, background: C.bg, overflowY: "auto" },
  aboutContent: { maxWidth: 520, margin: "0 auto", padding: "48px 20px 60px", position: "relative" },
  aboutClose: { position: "absolute", top: 16, right: 16, background: "none", border: "none", fontSize: 22, color: C.muted, cursor: "pointer", padding: 8 },
  aboutTitle: { fontFamily: "'Playfair Display',serif", fontSize: 22, fontWeight: 900, letterSpacing: "0.1em", textAlign: "center", marginBottom: 8 },
  aboutDivider: { width: 40, height: 2, background: C.red, margin: "0 auto 28px" },
  aboutImgFrame: { borderRadius: 4, overflow: "hidden", border: `1px solid ${C.border}`, marginBottom: 12, boxShadow: "0 2px 12px rgba(0,0,0,0.08)" },
  aboutImg: { width: "100%", display: "block" },
  aboutPaintingTitle: { fontSize: 16, fontWeight: 700, color: C.text, fontFamily: "'Playfair Display',serif", textAlign: "center", marginBottom: 2 },
  aboutPaintingArtist: { fontSize: 13, color: C.text, textAlign: "center", marginBottom: 4, fontFamily: "'Inter',sans-serif", letterSpacing: "0.02em" },
  aboutPaintingCaption: { fontSize: 12, color: C.muted, textAlign: "center", lineHeight: 1.5, marginBottom: 2, fontStyle: "italic" },
  aboutDivider2: { width: "100%", height: 1, background: C.border, margin: "24px 0" },
  aboutText: { fontSize: 14, lineHeight: 1.75, color: C.text, fontFamily: "'Playfair Display',serif", marginBottom: 14 },
  aboutPunch: { fontSize: 15, lineHeight: 1.75, color: C.text, fontFamily: "'Playfair Display',serif", fontWeight: 700, fontStyle: "italic", marginBottom: 14 },
  aboutLink: { color: C.red, textDecoration: "underline", textUnderlineOffset: 3 },
  aboutBackBtn: { width: "100%", background: C.surface, color: C.text, border: `2px solid ${C.text}`, borderRadius: 4, padding: 14, fontSize: 14, fontWeight: 600, cursor: "pointer", marginTop: 24, fontFamily: "'Inter',sans-serif" },
};
